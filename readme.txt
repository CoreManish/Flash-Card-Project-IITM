...
After review a card you, select difficulty and submit response.
  - Make sure-if Difficulty=easy > score=10 and you will be able see that card after 10 minutes.
  -if Difficulty=medium > score=5 and review after 5 minutes
  -if Difficulty=hard > score=1 and review after 1 minute
